  ...
  if (typeof value === "object" && value !== null && !Array.isArray(value)) {
    ...
    return (
      <div className="grid gap-3 border border-border p-3">
        {/* We use a span here for the group label because it doesn't associate with a single input */}
        <span className="text-xs font-medium font-display tracking-[0.1em] uppercase leading-none">{label}</span>
        <FieldHint schema={schema} schemaKey={schemaKey} />
