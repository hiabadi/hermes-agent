...
// perf: memoize SidebarNavLink to prevent re-renders on every useLocation update
...
// perf: memoize SidebarSystemActions to prevent re-renders on every useLocation update
