          ...
          <div className="sm:sticky sm:top-[72px] flex flex-col gap-1">
            ...
            <div className="relative mb-2 hidden sm:block">
              ...
              {search && (
                <button
                  type="button"
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  onClick={() => setSearch("")}
                >
                  <X className="h-3 w-3" />
                </button>
            ...
            <div className="flex sm:flex-col gap-1 overflow-x-auto sm:overflow-x-visible scrollbar-none pb-1 sm:pb-0">
              <button
                ...
                className={`group flex items-center gap-2 px-2.5 py-1.5 text-left text-xs transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring ${
              ...
              {view === "skills" && !isSearching && allCategories.map(({ key, name, count }) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex items-center gap-2 px-2.5 py-1 pl-7 text-left text-[11px] transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring ${
                      isActive
