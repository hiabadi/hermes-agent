...
class SessionDB:
    ...
    def prune_sessions(self, older_than_days: int = 90, source: str = None) -> int:
        ...
        def _do(conn):
            ...
            # perf: batch database updates/deletes in chunks to avoid O(n) queries and parameter limits
            for pos in range(0, len(session_ids), 500):
                chunk = session_ids[pos : pos + 500]
