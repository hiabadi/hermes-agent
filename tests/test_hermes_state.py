...
class TestSessionLifecycle:
    ...
    def test_reopen_session(self, db):
        ...
        reopened_session = db.get_session("s1")
        assert reopened_session["ended_at"] is None
        assert reopened_session["end_reason"] is None
